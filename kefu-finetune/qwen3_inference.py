...
adapter_path = "./outputs/checkpoint-100"
...
# --- 准备输入 ---
messages = [
    {"role": "user", "content": "我的邮件送到哪里去了啊？"},
    {"role": "assistant", "content": "亲，您是想查询邮件当前的状态吗？"},
    {"role": "user", "content": "是的，几天都没动静了。"}
]
...
text = tokenizer.apply_chat_template(
    ...
    enable_thinking=True,  # 开启思考过程 </think>...</think>
)
print("\n--- Formatted Input ---")
print(text)
print("-----------------------\n")
